...
-- Advisory lock helpers for delete-account concurrent-request serialization.
-- See supabase/migrations/20260425_delete_account_advisory_lock.sql for rationale.
...
'Non-blocking advisory lock for delete-account flow. Returns TRUE if acquired. Only callable by service_role.';
