  ...
  return (
    <svg viewBox="0 0 100 100" width={size} height={size} xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      ...
      <g filter={'url(#' + filterId + ')'} fill="none" stroke={ink} strokeOpacity="0.9">
        ...
        <text x="50" y="62" textAnchor="middle" fontFamily="'Fraunces', serif" fontStyle="italic" fontSize="28" fontWeight="900" letterSpacing="-1.5" fill={ink} stroke="none">wgh</text>
      </g>
    </svg>
  )
}
